...
RSpec.describe Product, :type => :model do
  describe 'Validations' do
    ...
    it 'should create a product if all validations pass' do
      ...
      @product = Product.new(name: "Electric Chair", price_cents: 3500, quantity: 35, :category => @category)
      @product.valid?
    ...
    it 'should not create a product if the quantity is missing' do
      @category = Category.new(name: "Testing")
      @product = Product.new(name: "Electric Chair", price_cents: 3500, :category => @category)
      @product.valid?
    ...
    it 'should not create a product if the price is missing' do
      @category = Category.new(name: "Testing")
      @product = Product.new(name: "Electric Chair", quantity: 35, :category => @category)
      @product.valid?
    ...
    it 'should not create a product if the category is missing' do
      @category = Category.new(name: "Testing")
      @product = Product.new(name: "Electric Chair", price_cents: 3500, quantity: 35)
      @product.valid?
